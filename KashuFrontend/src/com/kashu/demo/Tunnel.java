...
public class Tunnel extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			url = "http://localhost:8080/KashuBackend/MessageServlet";
			...
			System.out.println("Tunnel.doPost()");
			System.out.println(json_in.toString());
			//wr.write(json_in.toString());
			out.write(json_in.toString().getBytes("UTF-8"));
		...
		System.out.println("Tunnel.doPost()打印sb=" +sb.toString());
